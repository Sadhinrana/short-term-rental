                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <div class="out-img">
                                ...
                                <div class="alert alert-warning" style="font-size: 10px" v-if="NumberInImage != ''">
                                    <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>
                                    We detected the number @{{ NumberInImage }} in this image. Does this appear to be the street number?
                                    <button type="button" class="btn btn-sm btn-info btn-circle" @click="searchProperty"><i class="fa fa-check-circle"></i></button>
                                    <button type="button" class="btn btn-sm btn-danger btn-circle" onclick="document.querySelector('.alert-warning').style.display = 'none'"><i class="fa fa-minus-circle"></i></button>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                            ...
                            <div class="out-img">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-6 text-right">
                                        <button type="button" class="btn btn-default border-btn" value="Toggle Street View" @click="staticView">Static Street View</button>
                                    </div>
                                </div>
                                <div v-if="staticViewImage">
                                    <img :src="nooPropertyImage" alt="" width="100%">
                                </div>
    ...
    <script>
        ...
        const vueApp = new Vue({
            ...
            methods: {
                ...
                StreetViewMap() {
                    document.getElementById('nooPropertyMap').style.display = 'block';
                    let _this = this;
                    this.staticViewImage = false;
                ...
                searchProperty() {
                    $('#mapSearchStreetNo').val(this.NumberInImage);
                    this.searchNOOPropertyByStreet(1);
                },

                staticView() {
                    this.staticViewImage = true;
                    document.getElementById('nooPropertyMap').style.display = 'none';
                }
            }
        })
    </script>
