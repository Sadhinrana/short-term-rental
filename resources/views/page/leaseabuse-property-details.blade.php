                                ...
                                <div class="col-12 col-sm-2">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{ $masterProperty->name }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-2">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{  $masterProperty->latitude  }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-2">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{ $masterProperty->longitude }}</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number text-center text-muted mb-0"><a
                                                    href="{{ $masterProperty->URL }}"
                                                    target="_blank">{{ $masterProperty->URL }}</a></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-2">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{ $masterProperty->price }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-muted mb-0">{{ $masterProperty->listing_name  }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-2">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{ $masterProperty->room_type  }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-2">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{ $masterProperty->floor_size_value  }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-2">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{ $masterProperty->floor_size_unit }}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-2">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{ $masterProperty->address  }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-2">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{ $masterProperty->no_of_people }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-2">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{ $masterProperty->no_of_bathroom }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-2">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{ $masterProperty->num_bedroom }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-2">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{ $masterProperty->num_floor }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-2">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0">{{ $masterProperty->num_room }}</span>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                @if($closestsProperty)
                                                    @foreach($closestsProperty as $key=>$row)
                                                        ...
                                                        <tr>
                                                            <td>{{ $key+1 }}</td>
                                                            <td><a target="_blank"
                                                                   href="{{ $link }}">{{ $row->IDX_Address }}</a></td>
                                                            <td>
                                                                @if($row->image)
                                                                    <a data-toggle="modal" href="javascript:void(0)"
                                                                       class="NooPropertyImage"
                                                                       id="{{ $row->id }}" data-id="{{ $row->id }}"
                                                                       data-target="#exampleModalCenter"><img
                                                                            src="{{ asset($row->image) }}" height="60"
                                                                            width="80"></a>
                                                                @else
                                                                    No Image Available
                                                                @endif
                                                            ...
                                                            <td>
                                                                <a title="Details" target="_blank"
                                                                   ...
                                                                   href="{{ url('/noo-property-details',$row->id) }}"><i
                                ...
                                @if($details)
                                        ...
                                        <div class="info-box bg-light">
                                            ...
                                            @foreach($details->region_listing_image as $key=> $row)
                                                        <a data-toggle="modal" href="javascript:void(0)" class="image"
                                                           id="{{ $row->id }}" data-target="#exampleModalCenter"><img
                                                                src="{{ asset($row->image) }}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="info-box bg-light">
                                            <div class="info-box-content">
                                            <span
                                                class="info-box-text text-center text-muted">Listing Screenshots</span>
                                                <span class="info-box-number text-muted mb-0"
                                                      style="height: 500px;overflow: scroll;">
                                                @foreach($details->region_listing_screeshot as $key=> $row)
                                                        <a href="{{ asset($row->image) }}" target="_blank"><img
                                                                src="{{ asset($row->image) }}" class="img-rounded"
                                                                alt="Responsive Image"
                                                                style="padding: 8px 0;width: 100%"/></a>
                                                        <br>
                                                        <br>
                                                    @endforeach
                                        </span>
